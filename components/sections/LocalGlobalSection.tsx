      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-base sm:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed">
            We understand local business challenges and regulatory realities — while delivering software that meets international engineering standards. That combination is rare, and it&apos;s what we do.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.div
            variants={fadeInLeft}
            className="glass-card rounded-2xl p-8 border border-emerald-500/15 hover:border-emerald-500/30 transition-all duration-300 group"
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-base font-semibold text-white">Local Understanding</h3>
                <p className="text-xs text-gray-500">Rooted in Rwanda</p>
              </div>
            </div>
          ...
          <motion.div
            ...
            className="glass-card rounded-2xl p-8 border border-blue-500/15 hover:border-blue-500/30 transition-all duration-300 group"
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-base font-semibold text-white">Global Standards</h3>
                <p className="text-xs text-gray-500">Ready for anywhere</p>
              </div>
            </div>
            <ul className="space-y-3">
              {globalPoints.map((p) => (
