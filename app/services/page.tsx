...
import {
  Monitor, Smartphone, Plug, Building2, Brain,
...
const services = [
  {
    ...
    description:
      "We build web applications — from internal tools to customer-facing products — using modern, scalable architectures. Whether you need an MVP or a complex platform, we engineer it properly from the start.",
    useCases: [
    ...
    benefits: [
      ...
      "Built for growth and maintenance",
    ],
    color: "blue",
  ...
  },
  {
    ...
    description:
      "iOS and Android applications built with React Native. We handle the full lifecycle — from design to store submission — with a focus on smooth performance and real user experience.",
    useCases: [
      "Consumer mobile applications",
      "Field operations apps",
      "Mobile companion to web systems",
      "Offline-first tools",
  ...
  },
  {
    ...
    description:
      "We design and build APIs that power your products, and we integrate third-party services so your systems talk to each other. Payment gateways, ERPs, CRMs, communication tools — we wire it all together.",
    useCases: [
      "Payment gateway integration (Stripe, MTN, Flutterwave)",
    ...
    benefits: [
      "Clean, documented REST APIs",
      "Secure authentication (OAuth, JWT)",
      "Error handling and retry logic",
      "Performance and rate limit management",
    ],
    color: "emerald",
  ...
  },
  {
    ...
    description:
      "HR, payroll, invoicing, inventory, and reporting tools built for how your business actually operates. We don't fit your processes into generic software — we build something that fits you.",
    useCases: [
  ...
  },
  {
    ...
    description:
      "We integrate AI and machine learning capabilities into your applications — without the hype. Practical AI that solves real problems: smarter search, document processing, automated reporting, and intelligent recommendations.",
    useCases: [
      "Smart document extraction and parsing",
    ...
    benefits: [
      "Uses proven AI APIs (OpenAI, Anthropic)",
    ...
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden grid-bg">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/3 right-1/3 w-[500px] h-[500px] bg-violet-600/6 rounded-full blur-[120px]" />
        </div>
                ...
                <div className="flex flex-col lg:flex-row lg:gap-16">
                  ...
                  <div className="lg:w-1/2 mb-8 lg:mb-0">
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      <span className={`px-2.5 py-1 rounded-lg text-xs font-semibold border ${service.tagColor}`}>
                        {`0${i + 1}`}
                      </span>
                    </div>
                    ...
                    <Button href="/contact" variant="secondary" size="sm" icon>
                  ...
                  <div className="lg:w-1/2 grid sm:grid-cols-2 gap-5">
                    <div>
                      <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3">Use Cases</h3>
                      <ul className="space-y-2">
                        {service.useCases.map((uc) => (
                          <li key={uc} className="flex items-start gap-2 text-sm text-gray-400">
                            <ArrowRight className={`w-3.5 h-3.5 ${service.iconColor} flex-shrink-0 mt-0.5`} />
                            {uc}
                          </li>
                        ))}
                      </ul>
                    ...
                    <div>
                      <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-widest mb-3">What You Get</h3>
                      <ul className="space-y-2">
                        {service.benefits.map((b) => (
                          <li key={b} className="flex items-start gap-2 text-sm text-gray-400">
                            <CheckCircle2 className={`w-3.5 h-3.5 ${service.iconColor} flex-shrink-0 mt-0.5`} />
                            {b}
                          </li>
                        ))}
                      </ul>
